...
#include "GMCExPawn_Base.generated.h"

/**
 * @class AGMCExPawn_Base
 ...
 */
UCLASS()
class GMCEX_API AGMCExPawn_Base : public AGMC_Pawn, public IGMCE_MotionWarpSubject
{
	GENERATED_BODY()

public:
	AGMCExPawn_Base(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	TObjectPtr<UGMCExMovementComponent> MovementComponent;
