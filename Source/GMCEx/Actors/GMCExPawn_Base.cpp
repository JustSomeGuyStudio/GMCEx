...
AGMCExPawn_Base::AGMCExPawn_Base(const FObjectInitializer& ObjectInitializer) :
...
void AGMCExPawn_Base::BeginPlay()
{
	Super::BeginPlay();
	
	MovementComponent = GetComponentByClass<UGMCExMovementComponent>();
...
void AGMCExPawn_Base::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
...
void AGMCExPawn_Base::Respawn_Internal()
{
...
void AGMCExPawn_Base::CL_Respawn_Implementation()
{
...
void AGMCExPawn_Base::SV_Respawn_Implementation()
{
	Respawn_Internal();
}

void AGMCExPawn_Base::OnRespawnCallback()
{
...
void AGMCExPawn_Base::OnRespawn_Implementation()
{
}

USkeletalMeshComponent* AGMCExPawn_Base::MotionWarping_GetMeshComponent() const
{
	return MotionWarpingMeshComponent;
}

float AGMCExPawn_Base::MotionWarping_GetCollisionHalfHeight() const
{
...
FQuat AGMCExPawn_Base::MotionWarping_GetRotationOffset() const
{
...
FVector AGMCExPawn_Base::MotionWarping_GetTranslationOffset() const
{
...
FAnimMontageInstance* AGMCExPawn_Base::GetRootMotionAnimMontageInstance(
...
UGMCE_OrganicMovementCmp* AGMCExPawn_Base::GetGMCExMovementComponent() const
{
